...
# Виды морфем
EO_BASE = {
    "Va": VORTETOJ.Va,  # VORTETOJ - слова, которые не требуют окончания
    "Vp": VORTETOJ.Vp,
    "Vpl": VORTETOJ.Vpl,
    "Vpa": VORTETOJ.Vpa,
    "Vr": VORTETOJ.Vr,
...
EO_REGULOJ = {
    "w": ["N", "Vr", "Vp", "Vpl", "Vpa", "Va"] + ["aF", "bVr"],  # начальное состояние
    "a": ["N", "R", "A", "Vr", "Vp", "Vpa"]
    + ["bR", "bA", "bVr"]
    + ["dS"],  # состояние после окончания
    "b": ["N", "R", "A", "Vr", "Vp", "Vpl"]
    + ["bR", "bA", "bVr"]
    + ["cK", "dS"],  # сосотояние после корня или корнеподобной морфемы
    "c": ["N", "R", "A", "Vr", "Vp", "Vpl"]
    + ["bR", "bA", "bVr"],  # состояние после соединительной гласной
    "d": ["N", "R", "A", "Vr", "Vp", "Vpl", "Vpa", "Va"]
    + ["aF", "bR", "bA", "bVr"],  # состояние поcле дефиса
}
